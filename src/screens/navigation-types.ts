...
export type ImageToSpeechStackNavigatorProps = BottomTabScreenProps<
  CaregiverTabParamList,
  'Image to Speech'
>;
export type RecipientSelectionProps = StackScreenProps<
...
export type ForumStackNavigatorProps = BottomTabScreenProps<
  CaregiverTabParamList,
  'Forum'
>;
export type HomeProps = StackScreenProps<ForumStackParamList, 'Home'>;

export type SettingsStackNavigatorProps = BottomTabScreenProps<
  CaregiverTabParamList,
  'Settings'
>;
export type MainMenuProps = StackScreenProps<
